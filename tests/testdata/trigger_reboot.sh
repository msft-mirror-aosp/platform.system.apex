...
# $ adb shell setprop persist.debug.trigger_reboot_after_activation com.android.tzdata@300000000
active_apex=/apex/`/system/bin/getprop persist.debug.trigger_reboot_after_activation`
if [[ $active_apex == *@* ]]
then
    while :
    do
